...
{
public:
  SoftwareWire(uint8_t sdaPin, uint8_t sclPin);
...
private:
  ...
  inline void  i2c_sda_lo(void);
  inline void i2c_scl_lo(void);
  inline void i2c_sda_hi(void);
  inline void i2c_scl_hi(void);            
  inline int i2c_sda_read(void);
  inline int i2c_scl_read(void);
};
