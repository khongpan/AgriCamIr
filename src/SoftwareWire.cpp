...
//
SoftwareWire::SoftwareWire(uint8_t sdaPin, uint8_t sclPin):TwoWire(1)
{
  _sdaPin = sdaPin;
  _sclPin = sclPin;
}

SoftwareWire::SoftwareWire(uint8_t sdaPin, uint8_t sclPin, boolean pullups, boolean detectClockStretch):TwoWire(1)
{
  _sdaPin = sdaPin;
  _sclPin = sclPin;
  _pullups = pullups;
...
inline void SoftwareWire::i2c_sda_lo(void)  {            
...
inline void SoftwareWire::i2c_scl_lo(void)  {
...
inline void SoftwareWire::i2c_sda_hi(void) {
...
// after that, a pullup resistor is switched on if needed.
inline void SoftwareWire::i2c_scl_hi(void)  {            
  pinMode(_sclPin,OUTPUT);
...
inline int SoftwareWire::i2c_sda_read(void) {
  pinMode(_sdaPin,INPUT_PULLUP);
  return digitalRead(_sdaPin);
}

inline int SoftwareWire::i2c_scl_read(void) {
